    ...
    <section class="Form my-4 mx-5">
        <div class="container">
            <div class="row no-gutters">
                <div class="col-lg-5 ">
                    <img src="img/contrato3.png" alt="" class="img-fluid black-white ">
                </div>
                <div class="col-lg-7 px-5 pt-5">
                    <h1 class="fw-bold py-3"> Entrar</h1>
                    <h4>Sistema de contratos</h4>
                    <form action="">
                        <div class="form-row">
                            <div class="col-lg-7">
                                <input type="text" placeholder="Seu nome" class="form-control my-3 p-4 ">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7">
